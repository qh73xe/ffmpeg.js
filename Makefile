...
COMMON_FILTERS = aresample scale crop overlay hstack vstack highpass lowpass afftdn anlmdn
COMMON_DEMUXERS = matroska ogg mov mp3 avi wav image2 concat
COMMON_DECODERS = vp8 h264 vorbis opus avi wav mp3 aac pcm_s16le mjpeg png
...
MP4_MUXERS = avi mp4 mp3 wav image2 null
MP4_ENCODERS = libx264 libmp3lame aac png wav avi pcm_s16le
